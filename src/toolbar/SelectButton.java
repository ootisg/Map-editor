...
public class SelectButton extends ToolbarItem {
	...
	public void use (int x, int y) {
		...
		if (!(mainPanel.getVariantMenu().getBoundingRectangle().contains(x + 160, y * 16) && !mainPanel.getVariantMenu().isHidden()) && !(mainPanel.getAttributeSelectRegion().getBoundingRectangle().contains(x + 160, y * 16) && !mainPanel.getAttributeSelectRegion().isHidden())) {
